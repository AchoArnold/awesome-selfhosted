...
- [httpSMS](https://httpsms.com/) - Use your Android phone as an SMS gateway to send and receive text messages via a simple programmable API. ([Source Code](https://github.com/NdoleStudio/httpsms)) `AGPL-3.0` `Go/Docker/Vue`
